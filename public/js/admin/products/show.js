      ...
      tbody.innerHTML += `
          <tr class="my-1 h-12 border-b border-gray-200 hover:bg-gray-200 transition-colors duration-200">
            ...
            <td class="flex h-12 gap-2 items-center">
              <button
                class="bg-green-400 text-black h-10 rounded-xl flex items-center justify-center gap-2 p-3"
              ...
              <button
                class="bg-red-400 text-black h-10 rounded-xl flex items-center justify-center gap-2 p-3"
              >
                Eliminar
              </button>
            </td>
